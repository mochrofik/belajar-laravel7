                        ...
                        <div class="p-5">
                            ...
                            <form action="/register" method="POST" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="last_name" class="form-control form-control-user @error('last_name') is-invalid @enderror " id="exampleLastName" required
                                ...
                                <div class="form-group">
                                    <input  name="nik" class="form-control form-control-user @error('nik') is-invalid @enderror " 
